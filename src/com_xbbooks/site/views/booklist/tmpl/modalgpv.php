...
/*******
 * @package xbBooks
 * @filesource admin/views/persons/tmpl/modalgpv.php
...
<div class="modal-body">
    <div style="margin:0 30px;">
		<iframe src="<?php echo JURI::root(); ?>/index.php?option=com_xbpeople&view=group&layout=default&tmpl=component&id="
